                        ...
                        <ul id="dropdown-blogs" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{route('blog.index')}}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">All Blog</a>
                            </li>
                            <li>
