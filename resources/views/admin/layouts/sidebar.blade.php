        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <!------  Review start ------------>
                    @canany(['review list', 'review_type list', 'review_type create', 'review_type update', 'review_type
                        delete', 'review_type show', 'review create', 'review update', 'review delete', 'review show'])
                        <li>
                            <button type="button"
                                class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                            ...
                            <ul id="dropdown-review" class="hidden py-2 space-y-2">
                                ...
                                @canany(['review list', 'review create', 'review update', 'review delete', 'review show'])
                                    <li>
                    ...
                    <li>
                        <a href="{{ route('service.index') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sidebaricon" viewBox="0 0 24 24"
                ...
                @endcanany
                    ...
                    <!--------Portfolio start---------->
                    @canany(['portfolio list'])
                        <li>
                            <a href="{{ route('portfolio.index') }}"
                                class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="sidebaricon" fill="none"
                    ...
                    <!--------------Setting start------>
                    @canany(['websitesetting', 'socialmedia setting', 'contactsetting', 'chatsatting'])
                        <li>
