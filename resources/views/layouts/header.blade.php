    ...
    <div class="container mx-auto flex items-center justify-between lg:py-2 py-2 px-5 lg:px-0">
        ...
        <div class="">
            ...
            <div class="space-x-3 hidden lg:flex">
                <button type="button"
                    class="bg-brand py-2 px-3 inline-flex items-center gap-x-2 text-md font-bold rounded-sm bg-primary text-white hover:bg-black disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
