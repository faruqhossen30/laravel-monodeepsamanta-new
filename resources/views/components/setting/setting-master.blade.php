...
@section('content')
    ...
    <section
        class="mx-auto bg-white border-2 rounded-md dark:bg-gray-800 dark:text-slate-400 dark:border-gray-500">
        ...
        <div class="grid grid-cols-6 w-full">
            <div class="col-span-1 border dark:border-gray-500">
                ...
                <ul class="pb-2 border-t border-gray-200 shadow-sm dark:border-gray-500">
