                ...
                <ul class="pb-2 space-y-2 border-t border-gray-200 shadow-sm dark:border-gray-500">
                    ...
                    <li>
                        <a href="{{ route('setting.aboutme') }}"
                            ...
                            <span class="ml-3 text-gray-600 rounded-lg hover:text-gray-800 hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 " sidebar-toggle-item>About Me</span>
                        </a>
                    </li>
                    <li>
