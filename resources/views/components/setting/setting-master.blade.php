...
@section('content')
    ...
    <section
        class="mx-auto bg-white border rounded-md dark:bg-gray-800 dark:text-slate-400 dark:border-gray-500">
        ...
        <div class="grid grid-cols-6 w-full border border-gray-200 dark:border-gray-500">
            <div class="col-span-1 border-gray-200 dark:border-gray-500 border-r ">
                ...
                <ul class="divide-y divide-gray-200 dark:divide-gray-500 border-gray-200 shadow-sm dark:border-gray-500">
                    ...
                    {{-- <li>
                        ...
                        <a href="#"
                            class="flex items-center p-3 text-base text-gray-900 border-gray-200 shadow-sm dark:border-gray-500 hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                    ...
                    <li class=" @if (request()->routeIs('setting.aboutme')) bg-gray-300 dark:bg-gray-700 @endif">
                    ...
                    @can('contactsetting')
                    <li class="@if (request()->routeIs('portfolio.video')) bg-gray-100 @endif">
                    ...
                    @endcan
                    @can('contactsetting')
                    <li class="@if (request()->routeIs('testmonial.video')) bg-gray-100 @endif">
            ...
            <div class="col-span-5 border-b dark:border-gray-500">
                <h3 class="px-4 py-3 dark:border-gray-500 border-b dark:text-gray-200 bg-gray-50 dark:bg-gray-900">{{ $title ?? 'Setting' }}</h3>
                {{ $slot }}
            </div>
        </div>
        {{-- sidebar end --}}
