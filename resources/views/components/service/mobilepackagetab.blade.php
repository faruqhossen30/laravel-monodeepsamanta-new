        ...
        <div class="border p-3 sticky top-36 rounded-md">
            <div class="lg:col-span-4">
                <div class="mb-4 border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-3" id="mobiledefault-tab" data-tabs-toggle="#mobiledefault-tab-content" data-tabs-active-classes="border-black tabactivecustomclass" data-tabs-inactive-classes="tabinactivecustomclass" role="tablist">
